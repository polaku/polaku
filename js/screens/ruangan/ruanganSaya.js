      ...
      <View>
        ...
        <View style={styles.container}>
          <View style={styles.title}>
            <Text style={{ fontSize: 18, fontWeight: 'bold', color: '#A6250F' }}> Pesanan Saya </Text>
            <TouchableHighlight onPress={() => this.props.navigation.navigate('Ruangan')}>
              <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#A6250F' }}> ruangan </Text>
            </TouchableHighlight>
          </View>
          <Tabs renderTabBar={() => <ScrollableTab tabsContainerStyle={{
            backgroundColor: '#F1F1F1',
            justifyContent: 'flex-start',
          }} />} tabBarUnderlineStyle={{ backgroundColor: '#A6250F' }} style={{ backgroundColor: '#red' }}>
